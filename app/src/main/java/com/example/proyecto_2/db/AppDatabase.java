...
@Database(entities = {assemblies.class, assembly_products.class, Customers.class, order_assemblies.class, order_status.class, orders.class,
        Product_categories.class, products.class, Ordenes_Recy.class, RecyclerPosition.class, New_Order_Table.class}, version = 1, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
            ...
            INSTANCE = Room.databaseBuilder(context,
                    ...
                    .addCallback(new RoomDatabase.Callback() {
                        ...
                        public void onCreate(@NonNull SupportSQLiteDatabase db) {
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (0, 0, 'Western Digital Purple WD10PURX, 3.5in, 1TB, SATA3, 6GB/s, 64MB, IntelliPower', 149900, 2);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (1, 0, 'Western Digital 3.5in SATA de 320GB a 7200 RPM / New-Pulls / WD3200AAJS / WD3200AAKS', 43500, 4);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (2, 0, 'Toshiba 3.5in 3TB, SATA 6.0Gb/s 64MB Cache, 7200 RPM', 209900, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (3, 0, 'Toshiba 3.5in de 1TB SATA', 1099, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (4, 0, 'Seagate ST2000DM006 2TB 3.5in 7200RPM SATA3 64MB', 158900, 1);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (5, 0, 'Seagate ST3000DM001 3TB 3.5in 7200RPM SATA3 64MB', 209900, 5);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (6, 0, 'Western Digital Purple WD20PURX, 3.5in, 2TB, SATA3, 6GB/s, 64MB, IntelliPower', 209900, 1);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (7, 0, 'Toshiba 3.5in 2TB, SATA 6.0Gb/s 64MB Cache, 7200 RPM', 15600, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (8, 0, 'Seagate 3.5in SATA de 4TB, 6 Gb/s, 5900 RPM', 289900, 3);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (9, 0, 'Toshiba 3.5in (DT01ACA050) SATA III / 500GB -- 7200RPM / 32MB', 104900, 5);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (10, 0, 'Seagate 3.5in 1TB Sata III 7200 RPM 64 MB ST1000DM003', 109900, 7);	");
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (12, 0, 'Estado sólido Kingston UV400 de 480 GB, 2.5in SATA III (6GB/s)', 298899, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (13, 0, 'Estado sólido Kingston UV400 de 120 GB, 2.5in SATA III (6GB/s)', 109900, 1);	");
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (15, 0, 'Unidad SSD Kingston 120GB SATA III 2.5in V300 (no incluye kit)', 99900, 6);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (16, 0, 'Estado sólido Kingston UV400 de 240 GB, 2.5in SATA III (6GB/s)', 179900, 2);	");
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (18, 0, 'UNIDAD SSD KINGSTON 240GB SATA III 2.5in V300 SV300S37A/240G (no incluye kit)', 149900, 2);	");
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (200, 2, 'LCD ACER 17in V173 DJOb 1280x1024 20000:1 5MS Color Negro (Cuadrado)', 129900, 2);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (201, 2, 'Touchscreen Elo 1509L IntelliTouch, 15in, Gris', 599900, 1);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (202, 2, 'HP Passport 1912nm para Internet de 18.5in', 329901, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (203, 2, 'LED Samsung LS24F350FHLXZX de 23.6in, Resolución 1920 x 1080 (Full HD), 4 ms, HDMI, VGA', 279900, 10);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (204, 2, 'LED Samsung S19F350HNL de 18.5in, Resolución 1366 x 768, 14 ms', 139899, 4);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (205, 2, 'LED HP 19KA, 18.5in, resolución 1366x768, VGA, Negro', 139899, 6);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (206, 2, 'LED HP V193 de 18.5in, resolución 1366 x 768, VGA, incluye teclado y mouse HP', 169901, 2);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (207, 2, 'LED LG 22M38A-B de 21.5in, resolución 1920 x 1080 Full HD, VGA', 199900, 1);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (208, 2, 'LG 19M38A-B, 18.5in LED, 1366 x 768 ,5ms, VGA, Negro', 149900, 3);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (209, 2, 'LED LG 19M37A de 18.5in, Resolución 1366 x 768', 149900, 0);	");
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (211, 2, 'LED Acer P166HQL Bb, 15in, WideScreen 1366x768, Negro', 119900, 2);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (212, 2, 'LED Samsung S27F350FHL de 27in, Resolución 1920 x 1080 (Full HD), 4 ms, HDMI, VGA', 459901, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (213, 2, 'LED Samsung LS22F350FHLXZX de 21.5in, Resolución 1920 x 1080 (Full HD), 5 ms, HDMI, VGA', 219900, 4);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (214, 2, 'LED DELL E1916H de 19in, resolución 1366 x 768 (210-AGND)', 159900, 7);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (215, 2, 'LED LG 24M38H-B de 23.6in, Resolución 1920 x 1080 Full HD, HDMI, VGA', 249900, 8);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (216, 2, 'LG 20MP48A-P, 19.5in, 1440x900, 5ms, VGA, IPS LED, Negro', 159900, 2);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (217, 2, 'LG 27MP38VQ-B, 27in LED, 1920 x 1080, 5ms, DVI-D, VGA, HDMI', 409900, 1);	");
                            ...
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (219, 2, 'ACER 19.5in LED V206HQL, VGA, VESA, Color Negro', 149900, 0);	");
                            db.execSQL("	INSERT INTO products (id, category_id, description, price, qty) VALUES (220, 2, 'LED Acer V176L B-MX 17in, 1280 x 1024', 149900, 2);	");
    ...
    public abstract assembly_productsDao Assembly_productsDao();

    public abstract CustomersDao customersDao();

    public abstract order_assembliesDao Order_assembliesDao();

    public abstract order_statusDao Order_statusDao();

    public abstract ordersDao OrdersDao();

    public abstract Product_CategoriesDao product_CategoriesDao();

    public abstract ProductsDao productsDao();

    public abstract New_Order_TableDao new_order_tableDao();

    public abstract RecyclerPositionDao recyclerPositionDao();

    public abstract Ordenes_RecyDao ordenes_RecyDao();
}
